...
#using KNN with best parameters a.k.a 1 neighbor and weights being uniform
  ...
  print("The k value is k = %d is %f and accuracy score on validation set is %f"  %(j, Accuracyknn))
  print("")
  print("The k value is k = %d is %f and F1 score on validation set is %f"  %(j, f1_score_best_model_valid))
  print(knn_confustion_matrix)
  print("")
  ...
  print("The k value is k = %d is %f and accuracy score on test is %f"  %(j, Accuracyknn_test)) #test set
  print("The k value is k = %d is %f and F1 score on test set is %f"  %(j, f1_score_best_model_test))
